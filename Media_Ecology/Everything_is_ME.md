...
I, Stephen Alfred Gutknecht, am a published author on operating sytems / computers. And I find it facinating that a retired professor from Sharah Lawrence College, who is not traine don computers - was able to see this metaphor of one app at a time DOS interface systems. In the Bill Moyers website telling of this interview, Campbell mentioned a command line shell insruction to load the IBM Displaywrite app. ["You buy a certain software, and there’s a whole set of signals that lead to the achievement of your aim, you know. And once you’ve set it for, let’s say, DW3, enter"](https://billmoyers.com/content/ep-2-joseph-campbell-and-the-power-of-myth-the-message-of-the-myth/)
...
So Campbell is describing using IBM PC-DOS or MS-DOS shell and typing "DW3" enter to launch an application, and how at that time different applications (such as Lotus 1-2-3 spreadsheet application, released since January 1983) had radially different internal command and user interfaces. So, it seems, that an 82 year old profesor of Compative Mythology who had authored 40 books was still an old dog learning new tricks, to use a mutli-purpose operationg systems (IBM PC-DOS / MS-DOS) and exiting one application and loading another.
